...
from cnn import LogisticRegression, generate_data
...
def evaluate_lenet5(learning_rate=0.1, n_epochs=200,
    ...
    datasets = generate_data(dataset)
    ...
    layer5 = LogisticRegression(input=layer4.output, n_in=100, n_out=5)
